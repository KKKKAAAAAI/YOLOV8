...
class TSSTG(object):
    ...
    def __init__(self,
        ...
        self.class_names = ["Bench Press", "Dumbbel Shoulder Press", "Dumbbell Lateral Raises",
                            "Squats", "Deadlift", "Shoulder rehabilitation", "Lumbar spine rehabilitation",
                            "Knee rehabilitation", "Lat Pulldown"]
